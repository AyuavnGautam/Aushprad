import 'package:anveshana/collector/registercol.dart';
            ...
            children: <Widget>[
              ElevatedButton.icon(
                style: ElevatedButton.styleFrom(
                  primary: Color.fromRGBO(33, 40, 82, 1.0),
  ...
  void signIn(String email, String password) async {
    if (_formKey.currentState!.validate()) {
      ...
      await _auth.signInWithEmailAndPassword(email: email, password: password)
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const ColHomeScreen())),
